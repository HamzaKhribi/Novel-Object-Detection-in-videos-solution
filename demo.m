...
% 
% load('/media/hamza/DATAPART1/DPM-CHOP/testingperson2007/2007/person_final');
% model.class = 'person';
%  model.vis = @() visualizemodel(model, ...
%                   1:2:length(model.rules{model.start}));
% test('48.jpg', model, 4);

load('/media/hamza/DATAPART1/DPM-CHOP/testingbicycle2007/2007/bicycle_final');
model.vis = @() visualizemodel(model, ...
                  1:2:length(model.rules{model.start}));
test('155.jpg', model, 1);
